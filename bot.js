 ...
 channel.setParent(message.guild.channels.find(channel => channel.name === "✮ ▬  ▬ Duyuru Kanalları▬  ▬ ✮")));
  ...
  .then(c => {
    ...
    c.overwritePermissions(role, {
       ...
       message.guild.owner.send("Gerekli Herşey Kuruldu Rahatına Bak! **Zorba'nın kıymetini bil :D**")
...
if (!modlogkanal) return;
	if (channel.type === "text") {
				...
				.setFooter(`,NoMoreChanges-BOT | Mod-Log Sistemi Kanal ID: ${channel.id}`)
